  ...
  private void setupChargeButtonListener() {
    ...
    ChargeButton.setOnClickListener(new Button.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (!message) {
          new AlertDialog.Builder(ChargeActivity.this).setTitle(R.string.exception).setMessage(R.string.error_info)
        ...
        new AlertDialog.Builder(ChargeActivity.this).setTitle(R.string.enter_mobile_phone_number)
            .setMessage(R.string.recharge_prompt).setView(mLayout)
            .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
              @Override
