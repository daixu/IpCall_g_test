...
public class CallLogDbAdapter {
   ...
   */
  private static final String DATABASE_CREATE = "create table logs (_id integer primary key autoincrement, "
  ...
  public Cursor fetchAlllogs() {
    return mDb.query(DATABASE_TABLE, new String[] { KEY_ROWID, KEY_NAME, KEY_NUMBER, KEY_TIME }, null, null, null,
        null, KEY_ROWID + " DESC");
  }
  ...
  public Cursor fetchlog(long rowId) throws SQLException {
    Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] { KEY_ROWID, KEY_NAME, KEY_NUMBER, KEY_TIME },
