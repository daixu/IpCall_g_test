...
public class CallerNumberSetter {
  ...
  private void showInputDialog(final Context context) {
    ...
    new AlertDialog.Builder(context).setTitle(context.getString(R.string.input_num))
        .setIcon(android.R.drawable.ic_dialog_info).setMessage(context.getString(R.string.your_answer_num))
        .setView(editor).setPositiveButton(context.getString(R.string.ok), new DialogInterface.OnClickListener() {
          @Override
