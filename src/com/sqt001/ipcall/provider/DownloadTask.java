...
public class DownloadTask extends UserTask<Void, String, Void> {
  ...
  private void downloadApk() throws Exception {
    ...
    while (true) {
      ...
      if ((tnow - tprint) > 1000) {
        ...
        publishProgress(String.format("下载 %.1f MB (%.1f KB/秒)", size_MB, speed_KB));
  ...
  private void handleFail() {
    new AlertDialog.Builder(context).setMessage(reason).setPositiveButton(context.getString(R.string.ok), null).show();
  }
}